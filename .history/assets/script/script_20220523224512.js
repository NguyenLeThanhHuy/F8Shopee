...
// Product action rating
    ...
    const rating_item5 = document.querySelector('.home-product-item__rating-5')
        ...
        rating_item1.addEventListener('click', () => {
            let index = 0;
            if(rating_item1.classList.contains('rated') && index > 0) {
                rating_item1.classList.remove('rated');
            }else if(rating_item1.classList.contains('rated') && index = 0){
                rating_item1.classList.remove('rated');        
            }else {
                rating_item1.classList.contains('rated') && index >0
            }
        })

        rating_item2.addEventListener('click', () => {
            if(rating_item2.classList.contains('rated')) {
        ...
        rating_item3.addEventListener('click', () => {
            if(rating_item3.classList.contains('rated')) {
        ...
        rating_item4.addEventListener('click', () => {
            if(rating_item4.classList.contains('rated')) {
        ...
        rating_item5.addEventListener('click', () => {
            if(rating_item5.classList.contains('rated')) {
