...
const btn_liked = document.querySelector('.home-product-item__like-liked')
...
btn_liked.addEventListener('click', () => {
    if($('.home-product-item__like-icon-fill.home-product-item__like-icon-fill').css('display') === 'none')
    {
       alert(" hello")
    }
    else{        
